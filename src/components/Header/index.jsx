...
function Header() {
  ...
  const isActiveLink = (href) => {
    ...
    // Home should only be active on the homepage
    // when there is no hash selected.
    if (hrefPath === "/") {
      return currentPath === "/" && !currentHash;
    }

    // Hash links such as /about-us#our-story
    // should only be active when their exact hash is selected.
    if (hrefHash) {
      return currentPath === hrefPath && currentHash === hrefHash;
    }

    // Do not highlight normal parent links when
    // a same-page hash link is currently selected.
    if (currentHash) {
      return false;
    }

    // Parent links remain active on their child routes.
    return (
        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            >
              ...
              <span>amisankalp2026@gmail.com</span>
            </a>
          </div>
      ...
      <div className="border-b border-gray-100 bg-white">
                      ...
                      className={`
                        ...
                        ${
                          active
                            ...
                            : "font-medium text-gray-800 hover:text-brand-teal"
                        }
                      `}
                    >
                    ...
                    {item.dropdown && (
                      ...
                      >
                        {item.dropdown.map((subItem) => {
                          const subItemActive = isActiveLink(
                            subItem.href
                          );
        ...
        >
          <div className="p-5">
                    ...
                    <Link
                      ...
                      className={`
                        ...
                        ${
                          active
                            ? "font-semibold text-brand-teal"
                            : "font-medium text-brand-navy hover:text-brand-teal"
                        }
                      `}
                    >
                      {item.label}
                          ...
                          return (
                            <Link
                              ...
                              className={`
                                ...
                                ${
                                  subItemActive
                                    ? "border-brand-teal bg-teal-50 font-semibold text-brand-teal"
                                    : "border-transparent text-gray-500 hover:border-brand-teal hover:bg-teal-50 hover:text-brand-teal"
                                }
                              `}
                            >
                              {subItem.label}
            ...
            <div className="mt-6 rounded-xl bg-[#f3f9fa] p-4">
              <p
                className="
                  mb-3
                  text-xs
