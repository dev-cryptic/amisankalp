...
>
  <div className="mx-auto max-w-[1200px]">
    ...
    <div className="mb-10">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-7 text-gray-500 sm:text-base">
        A glimpse into our journey, our communities, and the moments that
        inspire change.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {/* Large Placeholder */}
      <div className="group overflow-hidden rounded-2xl bg-gray-100 sm:col-span-2 sm:row-span-2">
        <div className="flex h-full min-h-[320px] items-center justify-center bg-gradient-to-br from-brand-navy/10 via-brand-teal/10 to-brand-orange/10">
      ...
      <div className="group overflow-hidden rounded-2xl bg-gray-100">
        <div className="flex h-64 items-center justify-center bg-gradient-to-br from-brand-teal/10 to-brand-navy/10 lg:h-full">
          <div className="text-center">
      ...
      {/* Placeholder 3 */}
      <div className="group overflow-hidden rounded-2xl bg-gray-100">
        <div className="flex h-64 items-center justify-center bg-gradient-to-br from-brand-orange/10 to-brand-teal/10 lg:h-full">
          <div className="text-center">
            <span className="text-3xl">📷</span>
            <p className="mt-2 text-xs font-medium text-gray-500">
              Gallery Image
      ...
      {/* Placeholder 4 */}
      <div className="group overflow-hidden rounded-2xl bg-gray-100">
        <div className="flex h-64 items-center justify-center bg-gradient-to-br from-brand-navy/10 to-brand-orange/10 lg:h-full">
          <div className="text-center">
            <span className="text-3xl">📷</span>
            <p className="mt-2 text-xs font-medium text-gray-500">
              Gallery Image
      ...
      {/* Placeholder 5 */}
      <div className="group overflow-hidden rounded-2xl bg-gray-100">
        <div className="flex h-64 items-center justify-center bg-gradient-to-br from-brand-teal/10 to-brand-orange/10 lg:h-full">
          <div className="text-center">
            <span className="text-3xl">📷</span>
            <p className="mt-2 text-xs font-medium text-gray-500">
              Gallery Image
